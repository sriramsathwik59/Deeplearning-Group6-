...
g_optimizer = optim.Adam(generator.parameters(), lr=0.02)
d_optimizer = optim.Adam(discriminator.parameters(), lr=0.02)
...
def train(data_loader, generator, discriminator, g_optimizer, d_optimizer, criterion, epochs=20):
    for epoch in range(epochs):
        for i, data in enumerate(data_loader):
            ...
            real_outputs = torch.sigmoid(torch.mean(real_outputs, dim=[2, 3], keepdim=True))  
            ...
            fake_outputs = torch.sigmoid(torch.mean(fake_outputs, dim=[2, 3], keepdim=True))
            ...
            outputs = torch.sigmoid(torch.mean(outputs, dim=[2, 3], keepdim=True))  
...
if __name__ == "__main__":
    dataset = FrameDataset(root_dir='/home/ubuntu/project/Train/set00/set00/V000/')
